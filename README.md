...
And I'm interested to design, build and implement pipeline systems which convert raw data into value ones. <br>
**Looking for Internship**, eager to apply knowledge and skill in the real-world use case.
